...
export const COUNTRY_CODES: CountryCodeOption[] = [
  { code: "+57", label: "🇨🇴 +57", phonePlaceholder: "321 1234567", idPlaceholder: "Ej: 1020304050 (cédula) o 900123456-7 (NIT de empresa)" },
  { code: "+52", label: "🇲🇽 +52", phonePlaceholder: "55 1234 5678", idPlaceholder: "Ej: RFC o CURP" },
  { code: "+51", label: "🇵🇪 +51", phonePlaceholder: "912 345 678", idPlaceholder: "Ej: 12345678 (DNI) o 20123456789 (RUC de empresa)" },
  { code: "+593", label: "🇪🇨 +593", phonePlaceholder: "99 123 4567", idPlaceholder: "Ej: 1234567890 (cédula) o 1234567890001 (RUC de empresa)" },
  { code: "+507", label: "🇵🇦 +507", phonePlaceholder: "6123-4567", idPlaceholder: "Ej: 8-123-4567 (cédula) o RUC de empresa" },
  ...
  { code: "+58", label: "🇻🇪 +58", phonePlaceholder: "0412 1234567", idPlaceholder: "Ej: V-12345678 (cédula) o J-123456789 (RIF de empresa)" },
  { code: "+56", label: "🇨🇱 +56", phonePlaceholder: "9 1234 5678", idPlaceholder: "Ej: 12.345.678-9 (RUT)" },
  { code: "+54", label: "🇦🇷 +54", phonePlaceholder: "11 1234-5678", idPlaceholder: "Ej: 12345678 (DNI) o CUIT de empresa" },
  { code: "+34", label: "🇪🇸 +34", phonePlaceholder: "612 345 678", idPlaceholder: "Ej: 12345678A (DNI/NIE) o CIF de empresa" },
  { code: "+1", label: "🇺🇸 +1", phonePlaceholder: "(555) 123-4567", idPlaceholder: "Documento de identidad (si aplica)" },
];
