      ...
      {result && (
        <div style={{ marginTop: 16 }}>
          ...
          <p style={{ fontSize: 12.5, color: "#5b5f6b", marginBottom: 16, maxWidth: 720 }}>
            ...
            de la @, con el dominio mal escrito) o el mismo nombre completo — nunca solo por compartir teléfono. Nada se borra: los
            registros, consentimientos y correos enviados de cada perfil siguen intactos; solo queda anotado cuál es "el mismo humano
            que" cuál, para poder contar personas únicas con precisión.
          </p>

          <h3 style={{ fontSize: 14, marginBottom: 4 }}>
            {result.needsReviewGroups} grupos necesitan revisión humana
          </h3>
