...
// Protected by middleware (same Basic Auth as the rest of /admin). Mirrors
// Ticket Tailor's own "Add a new ticket type" modal field for field — see
// TicketTypeModal.tsx and the TicketType model's own comment in
// schema.prisma.
